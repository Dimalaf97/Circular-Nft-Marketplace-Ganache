    ...
    try {
      ...
      const res = await  toast.promise(
        promise,{
          ...
          error : "Error! We can`t Upload the Image Something went wrong."
        }
      )
    ...
    try {
      ...
      const res = await  toast.promise(
        promise,{
          ...
          error : "Error! We can`t Upload the Metadata, Something went wrong."
        }
      )
    ...
    <BaseLayout>
      <div>
        <div className="py-4">
          { !nftURI &&
            <div className="flex">
              <div className="mr-2 font-bold underline  text- to-black">Do you have meta data already?</div>
              <Switch
                checked={hasURI}
          ...
          <div className="md:grid md:grid-cols-3 md:gap-6">
            <div className="md:col-span-1">
              <div className="px-4 sm:px-0">
                <h3 className="text-lg font-medium leading-6  text-white">List NFT</h3>
        ...
        <div className="md:grid md:grid-cols-3 md:gap-6">
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-lg font-medium leading-6  text-black">Create NFT Metadata</h3>
